...
export default {
  ...
  parameters: {
    ...
    layout: 'centered',
    backgrounds: {
      // A muted sage that complements Milo's pinks and echoes the
      // iris gold, mid-valued so the white whiskers stay visible.
      options: {
 ...
 * still. He blinks on his own schedule, with the occasional languid contented-cat slow
 * blink. Sweep the cursor past the edges of the viewport to see the tracking saturate.
 */
