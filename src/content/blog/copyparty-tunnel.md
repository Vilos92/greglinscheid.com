...
> **Update:** I now run copyparty through [greg-zone](https://github.com/Vilos92/greg-zone), the Docker Compose homelab in my [dotfiles](https://github.com/Vilos92/dotfiles). I no longer use the standalone image in this guide. See the [`copyparty` service in `docker-compose.yml`](https://github.com/Vilos92/greg-zone/blob/main/docker-compose.yml#L100-L127). The post below is kept for reference.
...
![greg's copyparty](/blog/copyparty-2025-08-15.png)
